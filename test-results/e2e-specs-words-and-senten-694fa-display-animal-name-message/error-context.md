...
- Name: e2e/specs/words-and-sentences.spec.ts >> Words and Sentences Page - Animal Display >> should display animal name message
- Location: e2e/specs/words-and-sentences.spec.ts:84:7
...
Locator: locator('.animal-name-display')
Expected: visible
Timeout: 5000ms
