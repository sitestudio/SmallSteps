...
- Name: e2e/specs/home.spec.ts >> Home Page - Grid Layout >> should show grid with max 4 rows
- Location: e2e/specs/home.spec.ts:247:7
...
Expected substring: "repeat(4"
Received string:    "64px 64px 64px"
```
